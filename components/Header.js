        ...
        <div className="sticky top-0 w-full flex items-center px-10 py-4 bg-slate-900 text-white z-10">
            <div className="relative w-full flex justify-between items-center">
                ...
                <div className={!show ? "hidden md:block space-x-3" : "absolute right-0 translate-y-2/3 w-full flex flex-col space-y-2 bg-slate-800 p-2 pb-4 rounded-md"}>
                    ...
                    <a href="#" className={!show ? "px-2 py-1.5 ml-2 hover:bg-green-500 transition-all duration-500 ring-2 ring-green-500 rounded" : "px-2 py-1.5 hover:bg-green-500 transition-all duration-500 ring-2 ring-green-500 rounded w-24 hover:translate-x-2 text-center ml-2 md:0"}>RESUME</a>
                </div>
